...
function Contact() {
  ...
  const sendMail = () => {
    if (subject && email && message) {
      setLoading(true)
      axios.post("/contactMe", { message, email, subject }).then((response) => {
      ...
      setLoading(false)
      showToast("Please fill in all fields below", "correction");
    }
  }
  ...
  const [sidebarTopOpen, setSidebarTopOpen] = useState(true);
  const [sidebarBottomOpen, setSidebarBottomOpen] = useState(true);
              ...
              <section className="contact-body">
                <div className="contact-info">
                  ...
                  <div className="inputs-container flex">
                    <button className="submit-mail" onClick={sendMail}>submit-message</button>
                    &nbsp;&nbsp;
        ...
        <div className="right-wing">
          <div className="right-wing-top">
            ...
            <div>
              ...
              <div className={`sidebar-body-contact contact-top ${sidebarTopOpen ? "opened" : "closed"}`}>
              ...
              <div className={`sidebar-body-contact contact-bottom ${sidebarBottomOpen ? "opened" : "closed"} `}>
                <div className="sidebar">
                  <div className="social-media-contact">
                    <div className="flex-align">
