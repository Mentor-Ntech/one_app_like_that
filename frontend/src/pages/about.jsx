        ...
        <div className="body">
          <div className="left-wing">
            <div className="left-wing-top">
              ...
              <div>
                <div className="page-title">about-me({tab === "bio" ? "bio" : tab === "education" ? "education" : "interest"})</div>
              </div>
            </div>
                ...
                <section className="about-body">
                  {
                    tab === "bio" ? (
                      <div id="form">
                        <div id="number" >
                          {lineNumber.length > 0 && lineNumber.map((num, index) => <span key={index}>{num + 1} *</span>)}
                        </div>
                        <div id="text" ref={element} style={{ width: '80%', lineHeight: '30px' }}>
                          <span>/**</span>
                          <span><b onClick={() => console.log(lineNum)}>About me (bio)</b></span>
                          I am a highly skilled software developer with over five (5) years’
                          experience in the tech space, I have experience in frontend, backend,
                          centralized and decentralized programming which cuts across all levels of
                          testing including performance functional integration and user
                          acceptance, I have had the privilege to design several organizations such
                          as Fintech, Ecommerce and Business owners applications. I Am Passionate
                          about solving complex problems through data-driven processes that
                          translate business objectives into digital solutions through software
                          development.
                          <br />
                          <span>*/</span>
                        </div>
          ...
          <div className="right-wing">
            <div className="right-wing-top">
              ...
              <div>
                ...
                <div className={`sidebar-body-about about-top ${sidebarOpen ? "opened" : "closed"}`}>
                  <div className="sidebar">
                    <div className="social-media-about" onClick={() => changeTab("bio")}>
                      <div className="flex-align">
                        <MdOutlineNavigateNext color="white" size={20} />&nbsp;<HiFolder color="#FF605C" size={25} />
                        &nbsp;bio
                      </div>
                    </div>

                    <div className="social-media-about" onClick={() => changeTab("interest")}>
                      <div className="flex-align">
                        <MdOutlineNavigateNext color="white" size={20} />&nbsp;<HiFolder color="#2C957E" size={25} />
                        &nbsp;interest
                      </div>
                    </div>

                    <div className="social-media-about" onClick={() => changeTab("education")}>
                      <div className="flex-align">
                        <MdOutlineNavigateNext color="white" size={20} />&nbsp;<HiFolder color="#9747FF" size={25} />
                        &nbsp;education
                      </div>
                    </div>
                ...
                <div className={`sidebar-body-contact about-bottom ${sidebarBottomOpen ? "opened opened-about" : "closed"} `}>
                  <div className="sidebar">
                    ...
                    <div className="social-media-contact">
                      <a href="https://www.linkedin.com/in/yusuf-mustahan-086006221" target="_blank">
                        <div className="flex-align">
                    ...
                    <div className="social-media-contact">
                      <a href="ttps://twitter.com/Yumustyung_DEV?t=V2nQRg0gbi2frQyvlOQA2g&s=09" target="_blank">
                        <div className="flex-align">
                          <BsTwitter size={17} />
                          &nbsp;Twitter
                        </div>
